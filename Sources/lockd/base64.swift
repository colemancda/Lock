...
public struct Base64 {
    ...
    public static func encode(_ data: [UInt8], linebreak: Int? = nil, alphabet: Base64Alphabet = .Default) -> String {
    ...
    public static func decode(_ data: [UInt8], alphabet: Base64Alphabet = .Default) -> [UInt8] {
    ...
    /// - parameter alphabet: (optional) Base64 alphabet to use
    /// - returns: Base64 string with padding
    public static func encode(_ string: String, linebreak: Int? = nil, alphabet: Base64Alphabet = .Default) -> String {
        return Base64.encode(string.utf8.map({ $0 }), linebreak: linebreak, alphabet: alphabet)
    }
    ...
    /// - parameter alphabet: (optional) Base64 alphabet to use
    /// - returns: decoded data
    public static func decode(_ string: String, alphabet: Base64Alphabet = .Default) -> [UInt8] {
        return Base64.decode(string.utf8.map({ $0 }), alphabet: alphabet)
    }
}